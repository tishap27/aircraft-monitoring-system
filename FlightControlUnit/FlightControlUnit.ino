...
void checkLandingAltitude() {
  ...
  if (rawDistance < 400 && rawDistance > 2) {
    smoothedDistance = (DISTANCE_FILTER_ALPHA * rawDistance) + ((1 - DISTANCE_FILTER_ALPHA) * smoothedDistance);
...
void displayOrientation() {
  ...
  Serial.print("° | Alt: "); Serial.print(lastDistance, 1);
  Serial.print("cm | Gear: "); Serial.print(gearDeployed ? "DOWN" : "UP");
  Serial.print(" | Fan: "); Serial.print(fanRunning ? "ON" : "OFF");
  Serial.print(" | Status: ");
...
void handleRunningState() {
  ...
  if (millis() - lastLCDUpdate >= 2000) {
    ...
    if (showPitchRoll && mpuAvailable) {
      lcd.print("P:"); lcd.print(pitch, 1);
      lcd.print(" R:"); lcd.print(roll, 1);
      lcd.setCursor(0,1);
      lcd.print("H:"); lcd.print(lastDistance, 0);
      lcd.print("cm G:"); lcd.print(gearDeployed ? "DN" : "UP");
    } else {
      lcd.print("Temp:"); lcd.print(preferredTemp, 1);
      lcd.print("C");
      lcd.setCursor(0,1);
      lcd.print("Fan:"); lcd.print(fanRunning ? "ON" : "OFF");
      lcd.print(" Alt:"); lcd.print(lastDistance, 0);
    }
