// ============================================================================
// UNO-2 RIGHT VALA : ENVIRONMENTAL CONTROL (TinkerCAD Version)
// Simplified for Arduino UNO pin limitations with L293D motor driver control
// ============================================================================
...
void setup() {
  ...
  Serial.println("Two-UNO Project - Slave");
  Serial.println("");
