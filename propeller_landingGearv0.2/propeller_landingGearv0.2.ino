...
// Add these near other MPU6050 variables (around line 68)
...
void updateOrientation() {
  ...
  // FIXED YAW CALCULATION - prevent overflow and drift
  ...
  // CRITICAL: Keep yaw in valid range to prevent overflow
